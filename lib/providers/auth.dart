...
class Auth with ChangeNotifier {
  ...
  Future<void> _authenticate(
    ...
    final url =
        'https://identitytoolkit.googleapis.com/v1/accounts:$urlSegment?key=AIzaSyDOvvxH8Dnd0wY0Qo-CwhGU37i9Zshabio';
    try {
  ...
  Future<bool> tryAutoLogin() async{
    ...
    final expiryData = DateTime.parse(extractedUser['expiryDate']);
